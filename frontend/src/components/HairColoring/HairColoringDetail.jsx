...
import specialist from "../../assets/barber2.avif";
...
export default function HairColoringDetail() {
  ...
  const handleBook = async () => {
    ...
    const bookingDetails = {
      doctorName: 'Riya Kapoor',
      specialization: 'Hair Colorist',
      address: 'Hair Coloring Studio',
      date: selectedDate,
      time: selectedSlot,
    ...
    <div className="haircut-detail-page">
      <div className="haircut-detail-cards">
        <div className="haircut-specialist-card">
          <img src={specialist} alt="Hair Coloring Specialist" className="haircut-specialist-img-main" />
          <div className="haircut-specialist-card-info">
            <h2>Riya Kapoor</h2>
            <p className="haircut-specialist-role">Hair Colorist</p>
            <p className="haircut-specialist-desc">
              Riya Kapoor is a creative hair colorist specializing in the latest trends and techniques. She brings vibrant color and shine to every client, ensuring a look that matches your personality.
            </p>
            <p className="haircut-specialist-extra">Specialization: Balayage, Highlights, Global Color, Ombre, Root Touch-Up</p>
          </div>
        </div>
        <div className="haircut-types-card">
          <h1>Hair Coloring Service</h1>
          <div className="haircut-types-list">
            <h3>Types of Hair Coloring & Specializations</h3>
            <ul>
              <li><b>Balayage:</b> Natural, sun-kissed highlights for a soft blend.</li>
              <li><b>Highlights & Lowlights:</b> Add dimension and depth to your hair.</li>
              <li><b>Global Color:</b> All-over color for a bold transformation.</li>
              <li><b>Ombre:</b> Gradual color transition from roots to tips.</li>
              <li><b>Root Touch-Up:</b> Maintain your color and cover greys.</li>
            </ul>
            <p className="haircut-types-desc">Our colorist will help you choose the perfect shade and technique to enhance your style and complement your features.</p>
          </div>
        </div>
      </div>
