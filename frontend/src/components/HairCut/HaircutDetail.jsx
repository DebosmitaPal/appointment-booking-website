...
import specialist from "../../assets/barber1.jpg";
import "./HaircutDetail.css";
...
export default function HaircutDetail() {
    ...
    <div className="haircut-detail-page">
      <div className="haircut-detail-cards">
        <div className="haircut-specialist-card">
          <img src={specialist} alt="Haircut Specialist" className="haircut-specialist-img-main" />
          <div className="haircut-specialist-card-info">
            <h2>Priya Sharma</h2>
            <p className="haircut-specialist-role">Senior Stylist</p>
            <p className="haircut-specialist-desc">
              Priya Sharma is a highly skilled stylist with over 10 years of experience in modern and classic haircuts. She is known for her attention to detail and ability to create styles that suit every face shape and personality.
            </p>
            <p className="haircut-specialist-extra">Specialization: Modern & Classic Haircuts, Layering, Texturizing, Face-Framing Styles</p>
          </div>
        </div>
        <div className="haircut-types-card">
          <h1>Haircut Service</h1>
          <div className="haircut-types-list">
            <h3>Types of Haircuts & Specializations</h3>
            <ul>
              <li><b>Classic Bob:</b> Timeless, chin-length cut for a sleek look.</li>
              <li><b>Layered Cut:</b> Adds volume and movement, great for all hair types.</li>
              <li><b>Pixie Cut:</b> Short, bold, and easy to maintain.</li>
              <li><b>Fade & Taper:</b> Clean, modern styles for men and women.</li>
              <li><b>Face-Framing Layers:</b> Customizes the cut to enhance your features.</li>
              <li><b>Texturizing:</b> For a natural, effortless finish.</li>
            </ul>
            <p className="haircut-types-desc">Our specialist will help you choose the perfect style to match your personality, lifestyle, and face shape. Whether you want a dramatic change or a subtle refresh, we offer a wide range of haircut services tailored to your needs.</p>
          </div>
        </div>
      </div>
