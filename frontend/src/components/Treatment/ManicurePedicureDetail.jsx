...
import specialist from "../../assets/barber6.webp";
...
export default function ManicurePedicureDetail() {
  ...
  const handleBook = async () => {
    ...
    const bookingDetails = {
      doctorName: 'Ananya Das',
      specialization: 'Manicure & Pedicure Expert',
      address: 'Manicure & Pedicure Studio',
      date: selectedDate,
      time: selectedSlot,
    ...
    <div className="haircut-detail-page">
      <div className="haircut-detail-cards">
        <div className="haircut-specialist-card">
          <img src={specialist} alt="Manicure & Pedicure Specialist" className="haircut-specialist-img-main" />
          <div className="haircut-specialist-card-info">
            <h2>Ananya Das</h2>
            <p className="haircut-specialist-role">Manicure & Pedicure Expert</p>
            <p className="haircut-specialist-desc">
              Ananya Das is a skilled expert in manicure and pedicure, providing relaxing and beautifying treatments for hands and feet. Her attention to detail ensures a perfect finish every time.
            </p>
            <p className="haircut-specialist-extra">Specialization: Spa Manicure, Spa Pedicure, Gel Polish, Foot Massage</p>
          </div>
        </div>
        <div className="haircut-types-card">
          <h1>Manicure & Pedicure Service</h1>
          <div className="haircut-types-list">
            <h3>Types of Manicure & Pedicure & Specializations</h3>
            <ul>
              <li><b>Spa Manicure:</b> Deep cleansing, exfoliation, and hydration for hands.</li>
              <li><b>Spa Pedicure:</b> Relaxing foot soak, scrub, and massage.</li>
              <li><b>Gel Polish:</b> Long-lasting color for hands and feet.</li>
              <li><b>Foot Massage:</b> Relieves tension and improves circulation.</li>
              <li><b>Classic Care:</b> Nail shaping, cuticle care, and polish.</li>
            </ul>
            <p className="haircut-types-desc">Our expert will pamper your hands and feet, leaving them soft, healthy, and beautifully groomed after every session.</p>
          </div>
        </div>
      </div>
