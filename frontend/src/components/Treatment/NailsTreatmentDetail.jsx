...
import specialist from "../../assets/barber5.webp";
...
export default function NailsTreatmentDetail() {
  ...
  const handleBook = async () => {
    ...
    const bookingDetails = {
      doctorName: 'Megha Singh',
      specialization: 'Nail Art Specialist',
      address: 'Nails Treatment Studio',
      date: selectedDate,
      time: selectedSlot,
    ...
    <div className="haircut-detail-page">
      <div className="haircut-detail-cards">
        <div className="haircut-specialist-card">
          <img src={specialist} alt="Nails Treatment Specialist" className="haircut-specialist-img-main" />
          <div className="haircut-specialist-card-info">
            <h2>Megha Singh</h2>
            <p className="haircut-specialist-role">Nail Art Specialist</p>
            <p className="haircut-specialist-desc">
              Megha Singh is a talented nail art specialist, known for her creative designs and attention to detail. She offers a wide range of nail treatments to keep your hands looking beautiful.
            </p>
            <p className="haircut-specialist-extra">Specialization: Gel Nails, Nail Art, Extensions, Classic Manicure</p>
          </div>
        </div>
        <div className="haircut-types-card">
          <h1>Nails Treatment Service</h1>
          <div className="haircut-types-list">
            <h3>Types of Nail Treatments & Specializations</h3>
            <ul>
              <li><b>Gel Nails:</b> Long-lasting, chip-resistant shine.</li>
              <li><b>Nail Art:</b> Creative designs for every occasion.</li>
              <li><b>Nail Extensions:</b> Add length and strength to your nails.</li>
              <li><b>Classic Manicure:</b> Clean, shape, and polish for healthy nails.</li>
              <li><b>French Tips:</b> Elegant and timeless style.</li>
            </ul>
            <p className="haircut-types-desc">Our specialist will help you choose the best treatment and design to match your style and keep your nails looking their best.</p>
          </div>
        </div>
      </div>
