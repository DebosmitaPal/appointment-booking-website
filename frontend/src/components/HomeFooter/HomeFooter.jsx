...
function HomeFooter() {
  return (
    <footer className="home-footer-bg">
      <div className="home-footer-content">
        <div className="home-footer-left">
          <div className="home-footer-title">SyncUniServe</div>
          <div className="home-footer-desc">SyncUniServe is your trusted platform for booking appointments with doctors, personal grooming experts, and home repair professionals. We make your life easier, one booking at a time.</div>
        </div>
        <div className="home-footer-center">
          <div className="home-footer-title">Follow us on</div>
        ...
        <div className="home-footer-right">
          <div className="home-footer-title">Get in Touch</div>
          <div className="home-footer-contact">Email: support@syncuniserve.com<br/>Address: SyncUniServe: Appointy Store, DP Road, Kolkata</div>
        </div>
      </div>
